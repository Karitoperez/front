<div class="my-4">
    ...
    <div class="">
        <div class="grid md:grid-cols-4 gap-8 m-8">
            ...
            <a href="{{ route('usuarios.create') }}"
                ...
                <span><i class="text-4xl fa-solid fa-user-group"></i> Agregar Usuario</span>
            </a>
            <a href="{{ route('cursos.create') }}"
                class="curso__agregar-leccion bg-green-600 shadow-md flex flex-col p-2 items-center justify-center h-24 rounded">
                <span><i class="text-4xl fa-solid fa-book-bookmark"></i> Agregar Curso</span>
            </a>
        ...
        <div class="">
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 m-8">
                <div
                    class="shadow-md flex flex-col p-2 items-center  justify-center rounded bg-gray-50 dark:bg-gray-800">
                    <p class="font-bold">Total de cursos <i class="fa-solid fa-chart-simple text-indigo-800"></i></p>
                    <p class="text-8xl font-bold text-indigo-800">
                        {{ $totalCursos }}
                    </p>
                </div>
                <div
                    class="shadow-md flex flex-col p-2 items-center justify-center rounded bg-gray-50 dark:bg-yellow-400-800">
                    <p class="font-bold">Total Administradores <i class="fa-solid fa-chart-simple text-yellow-400"></i>
                    </p>
                    <p class="text-8xl font-bold text-indigo-800">
                        {{ $administradoresCantidad }}
                    </p>
                </div>
                <div
                    class="shadow-md flex flex-col p-2 items-center justify-center rounded bg-gray-50 dark:bg-gray-800">
                    <p class="font-bold">Total docentes <i class="fa-solid fa-chart-simple text-green-800"></i></p>
                    <p class="text-8xl font-bold text-indigo-800">
                        {{ $docentesCantidad }}
                    </p>
                </div>
                <div
                    class="shadow-md flex flex-col p-2 items-center justify-center rounded bg-gray-50 dark:bg-yellow-400-800">
                    <p class="font-bold">Total estudiantes <i class="fa-solid fa-chart-simple text-yellow-400"></i></p>
                    <p class="text-8xl font-bold text-indigo-800">
                        {{ $estudiantesCantidad }}
                    </p>
                </div>
        ...
        <div class="">
            ...
            <div class="sm:grid md:grid-cols-2 w-full gap-4 p-2">
                <div class="">
                    <h2 class="font-bold text-center flex items-center justify-center gap-2 text-4xl my-4">Estudiantes
                        por categoria</h2>
                    <canvas class="canvas" id="categoriasEstudiantes"></canvas>
                </div>
                <div class="">
                    <h2 class="font-bold text-center flex items-center justify-center gap-2 text-4xl my-4">Estudiantes
                        por curso</h2>
                    <canvas class="canvas"  id="cursosEstudiantes"></canvas>
                </div>
            </div>
        </div>
    </div>
